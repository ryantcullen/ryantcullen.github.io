...
<img src="{{ '/assets/images/carelab/hardware_flowchart.png' | relative_url }}" alt="Hardware control platform selection flowchart" style="width: 75%;">
...
<img src="{{ '/assets/images/carelab/sim_flowchart.png' | relative_url }}" alt="Simulation platform selection flowchart" style="width: 75%;">
